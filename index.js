...
browser: ['Delta Felix','Safari','3.1.0'],
auth: state})
//=================================================//
...
let link = `https://youtube.com/@felixzyra`
let buttons = [
{buttonId: `DELTA FELIX☆`, buttonText: {displayText: hello}, type: 1},
]
let buttonMessage = {
...
let link = `https://youtube.com/@felixzyra`
let buttons = [
{buttonId: `DELTA FELIX☆`, buttonText: {displayText: bye}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
let buttons = [
{buttonId: `DELTA FELIX`, buttonText: {displayText: 'KASIAN'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
let link = `https://eclass.iainsalatiga.ac.id/app/upload/users/1/10892/my_files/XhiroMhonshine.html'`
let buttons = [
{buttonId: `DELTA FELIX`, buttonText: {displayText: 'SELAMAT'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
